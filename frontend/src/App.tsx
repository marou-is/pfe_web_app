  ...
  return (
    <div style={styles.page}>
      ...
      <footer style={styles.footer}>
        <span style={styles.footerText}>TruthLens · AI Detection Model</span>
      </footer>
    </div>
  )
}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  errorBox: {
    ...
    gap:          10,
    padding:      '14px 20px',
    background:   'color-mix(in srgb, var(--ai-high) 8%, transparent)',
    border:       '1px solid color-mix(in srgb, var(--ai-high) 30%, transparent)',
    borderRadius: 'var(--r-md)',
